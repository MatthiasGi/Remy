...
Step.create(recipe: recipe, number: -1, description: 'Alles klein schnibbeln!')
Step.create(recipe: recipe, number: 0, description: 'Alles schmoren!')
Step.create(recipe: recipe, number: 2, description: 'Alles essen!')
